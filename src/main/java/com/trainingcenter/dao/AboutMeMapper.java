...
public interface AboutMeMapper {
     ...
     */
    public Integer add(@Valid @Param("aboutMe") AboutMe aboutMe);


    /**
     * 动态培训更新方法
     * @param aboutMe：要更新的培训新闻
     * @return 返回操作成功的个数，0表示操作失败
     */
    public Integer update(@Valid @Param("aboutMe") AboutMe aboutMe);
