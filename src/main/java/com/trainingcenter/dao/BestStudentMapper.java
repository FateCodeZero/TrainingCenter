 ...
 */
@Repository("bestStudentMapper")
public interface BestStudentMapper {
    /**
     *
     * @param id 学员风采的ID
     * @return 学员风采
     ...
     * @return 返回学员风采对象集合
     */
    public List<BestStudent> getBestStudents(@Param("start") Integer start, @Param("number") Integer number,
                                             @Param("condition") Map<String,Object> condition);


    /**
     * 学员风采添加方法
     * @param bestStudent 学员风采
    ...
    /**
     * 学员风采更新方法
     * @param bestStudent：要更新的学员风采
     * @return 返回操作成功的个数，0表示操作失败
     */
    public Integer update(@Valid @Param("bestStudent") BestStudent bestStudent);
