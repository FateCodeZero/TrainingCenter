 ...
 */
@Repository("trainingDynamicMapper")
public interface TrainingDynamicMapper {
    /**
     *
     * @param id 动态培训的ID
     * @return 动态培训
     ...
     * @return 返回动态培训对象集合
     */
    public List<TrainingDynamic> getTrainingDynamics(@Param("start") Integer start, @Param("number") Integer number,
     ...
     * @return 返回操作成功的个数，0表示操作失败
     */
    public Integer update(@Valid @Param("trainingDynamic") TrainingDynamic trainingDynamic);
