 ...
 */
@Repository("culturalProductsMapper")
public interface CulturalProductsMapper {
    /**
     *
     * @param id 动态培训的ID
     * @return 动态培训
     */
    public CulturalProducts getCulturalProductsById(@Param("id") String id);
     ...
     * @return 返回动态培训对象集合
     */
    public List<CulturalProducts> getCulturalProductss(@Param("start") Integer start, @Param("number") Integer number,
                                                       @Param("condition") Map<String,Object> condition);


    /**
     * 动态培训添加方法
     * @param culturalProducts 培训新闻
    ...
    /**
     * 动态培训更新方法
     * @param culturalProducts：要更新的培训新闻
     * @return 返回操作成功的个数，0表示操作失败
     */
