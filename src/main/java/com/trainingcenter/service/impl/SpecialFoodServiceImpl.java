...
public class SpecialFoodServiceImpl implements SpecialFoodService {
    ...
    public List<SpecialFood> getSpecialFoods() {
        return getSpecialFoods(null, null, null);
    }
    /**
     *分页获取所以培训动态
    ...
    public List<SpecialFood> getSpecialFoods(Integer currentPage, Integer rows, String searchContent) {
            if(currentPage != null && rows != null) {
                ...
                return specialFoodMapper.getSpecialFoods(start, rows, searchContent);
            }
            else {
                return specialFoodMapper.getSpecialFoods(null,null,searchContent);
            }
    }
