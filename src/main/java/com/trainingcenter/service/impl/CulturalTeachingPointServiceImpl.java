...
public class CulturalTeachingPointServiceImpl implements CulturalTeachingPointService {
    ...
    public List<CulturalTeachingPoint> getCulturalTeachingPoints() {
        return getCulturalTeachingPoints(null, null, null);
    }
    /**
     *分页获取所以培训动态
    ...
    public List<CulturalTeachingPoint> getCulturalTeachingPoints(Integer currentPage, Integer rows, String searchContent) {
            if(currentPage != null && rows != null) {
                ...
                return culturalTeachingPointMapper.getCulturalTeachingPoints(start, rows, searchContent);
            }
            else {
                return culturalTeachingPointMapper.getCulturalTeachingPoints(null,null,searchContent);
            }
    }
