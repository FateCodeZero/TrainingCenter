...
<div  id="fh5co-about">
    <div id="experiential_details" class="container"></div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: 'GET',
            url: "${webRoot}/experientialTeaching/detailsPage",
            data: {id:id},
            dataType: "json",
            success:function (data) {
                ...
                if(code == 1){
                    var experiential_details = jsonData.data.items;
                    var id = experiential_details.id;
                    var title = experiential_details.title;
                    var content = experiential_details.content;
                    var imgs = experiential_details.imgs;

                    var experiential_details_div = '    <div id="'+id+' " class="container">' +
                    ...
                    $("#experiential_details").html(experiential_details_div);
                    IFrameResize();

                }else {
                    $("#experiential_details").html('<h3 class="col-md-12 text-center">'+msg+'</h3>');
                }
