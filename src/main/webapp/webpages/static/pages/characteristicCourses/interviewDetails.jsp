...
<div  id="fh5co-about">
    <div id="interview_details" class="container"></div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: 'GET',
            url: "${webRoot}/interviewTeaching/detailsPage",
            data: {id:id},
            dataType: "json",
            success:function (data) {
                ...
                if(code == 1){
                    var interview_details = jsonData.data.items;
                    var id = interview_details.id;
                    var title = interview_details.title;
                    ...
                    $("#interview_details").html(interview_details_div);
                    IFrameResize();

                }else {
                    $("#interview_details").html('<h3 class="col-md-12 text-center">'+msg+'</h3>');
                }
