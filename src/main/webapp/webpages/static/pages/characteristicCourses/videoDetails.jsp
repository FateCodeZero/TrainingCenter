...
<div  id="fh5co-about">
    <div id="video_details" class="container"></div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: 'GET',
            url: "${webRoot}/videoTeaching/detailsPage",
            data: {id:id},
            dataType: "json",
            success:function (data) {
                ...
                if(code == 1){
                    ...
                    $("#video_details").html(details_div);
                    IFrameResize();

                }else {
                    $("#video_details").html('<h3 class="col-md-12 text-center">'+msg+'</h3>');
                }
            },
            error:function (msg) {
                $("#video_details").html('<h3 class="col-md-12 text-center">'+msg+'</h3>');
