...
<div  id="fh5co-about">
    <div id="spot_details" class="container"></div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: 'GET',
            url: "${webRoot}/revolutionarySite/detailsPage",
            data: {id:id},
            dataType: "json",
            success:function (data) {
                ...
                if(code === 1){
                    ...
                    $("#spot_details").html(details_div);
                    IFrameResize();

                }else {
                    $("#spot_details").html('<h3 class="col-md-12 text-center">'+msg+'</h3>');
                }
            }
