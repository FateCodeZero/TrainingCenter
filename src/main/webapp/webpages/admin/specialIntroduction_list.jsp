...
<script type="text/javascript">
    ...
    function tableData() {
        layui.use('table', function () {
            ...
            table.render({
                ...
                , toolbar: '#table-head'
                , title: '菜单管理'
                , url: '${webRoot}/specialIntroduction/listPage' //数据接口
    ...
    function addData() {
        layer.open({
            ...
            fix: false, //不固定
            maxmin: true,
            content: '${webRoot}/webpages/admin/specialIntroduction_add.jsp',
    ...
    function editData(id) {
        layer.open({
            ...
            fix: false, //不固定
            maxmin: true,
            content: '${webRoot}/webpages/admin/specialIntroduction_edit.jsp?id=' + id,
            success: function (layero, index) {
                layer_window = layero;   //获取弹出窗口的窗口对象
            },
            end: function () {
    ...
    function deleteData(ids, count) {
        ...
        layer.confirm(tipMsg, {
            ...
            , function () { //确定之后执行
                ...
                $.ajax({
                    url: "${webRoot}/specialIntroduction/delete",
                    type: "get",
                    data: data,
                    dataType: "json",
