...
<script type="text/javascript">
    ...
    function addData() {
        layer.open({
            title: '添加与创业名人/团队交流调研教学',
            type: 2,
            area: ['1100px', '550px'],
            fix: false, //不固定
            maxmin: true,
            content: '${webRoot}/webpages/admin/communicationTeaching_add.jsp',
    ...
    function editData(id) {
        layer.open({
            title: '编辑与创业名人/团队交流调研教学',
            type: 2,
            area: ['1100px', '550px'],
            fix: false, //不固定
            maxmin: true,
            content: '${webRoot}/webpages/admin/communicationTeaching_edit.jsp?id=' + id,
            success: function (layero, index) {
                layer_window = layero;   //获取弹出窗口的窗口对象
            },
            end: function () {
