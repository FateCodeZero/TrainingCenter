    ...
    <div class="text-left col-sm-10 panel panel-primary">
        ...
        <form class="form-horizontal" role="form" action="">
            ...
            <div class="form-group">
                <label for="title" class="col-sm-2 control-label">文化教学点标题</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="name" id="title" value="" placeholder="请输入标题">
                </div>
            </div>
            <div class="form-group">
                <label for="content" class="col-sm-2 control-label">文化教学点内容</label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                <label for="imgs" class="col-sm-2 control-label">文化教学点图片</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="imgs" id="imgs" value="" placeholder="请给出图片链接">
                </div>
            </div>
            <div class="form-group">
                <label for="remark" class="col-sm-2 control-label">文化教学点备注</label>
                <div class="col-sm-10">
...
<script type="text/javascript">
    ...
    function getDataSourceById(id) {
        ...
        var data = {id: id};
        $.ajax({
            url: "${webRoot}/culturalTeachingPoint/getCulturalTeachingPointById",
            type: "get",
            async: false,    //关闭异步请求
            data: data,
            dataType: "json",
            success: function (data) {
                ...
                if (code === 1) {
                    Info = jsonData.data.culturalTeachingPoint;
                } else {
                    layer.alert(msg, {
                        time: 3000,
                        icon: 2
    ...
    $("#submit").click(function () {
        ...
        $.ajax({
            url: "${webRoot}/culturalTeachingPoint/update",
            type: "post",
            data: data,
            dataType: "json",
            success: function (data) {
