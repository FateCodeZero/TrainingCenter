    ...
    <div class="text-left col-sm-10 panel panel-primary">
        ...
        <form class="form-horizontal" role="form" action="">
            ...
            <div class="form-group">
                <label for="title" class="col-sm-2 control-label">特此介绍标题</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="name" id="title" value="" placeholder="请输入标题">
                </div>
            </div>
            <div class="form-group">
                <label for="content" class="col-sm-2 control-label">特此介绍内容</label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                <label for="imgs" class="col-sm-2 control-label">特此介绍图片</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="imgs" id="imgs" value="" placeholder="请给出图片链接">
                </div>
            </div>
            <div class="form-group">
                <label for="remark" class="col-sm-2 control-label">特此介绍备注</label>
                <div class="col-sm-10">
...
<script type="text/javascript">
    ...
    function getDataSourceById(id) {
        ...
        var data = {id: id};
        $.ajax({
            url: "${webRoot}/specialIntroduction/getSpecialIntroductionById",
            type: "get",
            async: false,    //关闭异步请求
            data: data,
            dataType: "json",
            success: function (data) {
                ...
                if (code === 1) {
                    Info = jsonData.data.specialIntroduction;
                } else {
                    layer.alert(msg, {
                        time: 3000,
                        icon: 2
    ...
    $("#submit").click(function () {
        ...
        $.ajax({
            url: "${webRoot}/specialIntroduction/update",
            type: "get",
            data: data,
            dataType: "json",
            success: function (data) {
