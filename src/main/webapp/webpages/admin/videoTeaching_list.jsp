...
<script type="text/javascript">
    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , toolbar: '#table-head'
            , title: '菜单管理'
            , url: '${webRoot}/videoTeaching/listPage' //数据接口
            , page: true //开启分页
            , limit: 10 //每页显示多少条数据
            ,height:550
            , cols: [[ //表头
    ...
    function addData() {
        layer.open({
            ...
            fix: false, //不固定
            maxmin: true,
            content: '${webRoot}/webpages/admin/videoTeaching_add.jsp',
    ...
    function editData(id) {
        layer.open({
            ...
            fix: false, //不固定
            maxmin: true,
            content: '${webRoot}/webpages/admin/videoTeaching_edit.jsp?id=' + id,
            success: function (layero, index) {
                layer_window = layero;   //获取弹出窗口的窗口对象
            },
            end: function () {
