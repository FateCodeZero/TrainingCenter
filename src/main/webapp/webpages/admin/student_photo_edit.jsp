...
<div class="row">
    ...
    <div class="text-left col-sm-10 panel panel-primary">
        ...
        <form class="form-horizontal" role="form" action="">
            ...
            <div class="form-group">
                <label for="content" class="col-sm-2 control-label">学员学习照内容</label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                <label for="imgs" class="col-sm-2 control-label">学员学习照图片</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="imgs" id="imgs" value="" placeholder="请给出图片链接">
                </div>
            </div>
            <div class="form-group">
                <label for="remark" class="col-sm-2 control-label">学员学习照备注</label>
                <div class="col-sm-10">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        /*通过ID获取对象信息*/
        var dataSource = getstudentMienById(InfoId);
        /*初始化编辑数据*/
     ...
     * @param id 新闻id
     */
    function getstudentMienById(id) {
        ...
        var data = {id: id};
        $.ajax({
            url: "${webRoot}/studentMien/getStudentMienById",
            type: "get",
            async: false,    //关闭异步请求
            data: data,
            dataType: "json",
            success: function (data) {
                ...
                if (code === 1) {
                    Info = jsonData.data.studentMien;
                } else {
                    layer.alert(msg, {
                        time: 3000,
                        icon: 2
    ...
    $("#submit").click(function () {
        ...
        if (id === null || id === ''){
            var msg = '<div style="text-align: center"><span style="color: #FF5722;font-size: large">学员学习照不存在或已被删除，</span><br>即将返回列表界面。</div>';
            layer.confirm(msg, {
                    btn: ['确定', '取消']//按钮
                }
                , function () { //确定之后执行
