   ...
   function tableData() {
       ...
       layui.use('table', function () {
           ...
           table.render({
               ...
               , toolbar: '#table-head'
               , title: '菜单管理'
               , url: '${webRoot}/advertisement/listPage' //数据接口
               ...
               , cols: [[ //表头
                   ...
                   , {field: 'describe', title: '描述', width: 200, align: 'describe'}
                   , {field: 'url', title: '链接', width: 200, align: 'center'}
                   , {field: 'start', title: '开始时间', width: 200, align: 'center'}
                   , {field: 'end', title: '结束时间', width: 150, align: 'center'}
                   , {
    ...
    function addData() {
        layer.open({
            ...
            fix: false, //不固定
            maxmin: true,
            content: '${webRoot}/webpages/admin/advertisement_add.jsp',
    ...
    function editData(id) {
        layer.open({
            ...
            fix: false, //不固定
            maxmin: true,
            content: '${webRoot}/webpages/admin/advertisement_edit.jsp?id=' + id,
            success: function (layero, index) {
                layer_window = layero;   //获取弹出窗口的窗口对象
            },
            end: function () {
